...
/// \file exoticphysics/QuSeN_QuantumAcoustic/src/QuSeN_QuantumAcousticPrimaryGeneratorAction.cc
/// \brief Implementation of the QuSeN_QuantumAcousticPrimaryGeneratorAction class
//
...
QuSeN_QuantumAcousticPrimaryGeneratorAction::QuSeN_QuantumAcousticPrimaryGeneratorAction() {
  //G4int n_particle = 1;
...
void QuSeN_QuantumAcousticPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent) {
